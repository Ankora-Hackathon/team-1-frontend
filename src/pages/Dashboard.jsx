      ...
      <div className='grid grid-cols-12 col-span-2 space-x-12'>
        <div className='col-span-2'>
          <div className='flex flex-col items-start space-y-4'>
            <button className='w-full px-4 py-2 bg-gray-800 rounded'>Dyagnose</button>
            <button className='w-full px-4 py-2 border border-gray-800 rounded'>History</button>
            <button className='w-full px-4 py-2 border border-gray-800 rounded'>Medications</button>
            <button className='w-full px-4 py-2 border border-gray-800 rounded'>Profile</button>
          </div>
        </div>
          ...
          <form onSubmit={(event) => handleOnSubmit({ event })} className='flex flex-col space-y-4'>
                ...
                <label className='flex flex-col px-4 py-2 space-y-2 border border-gray-800 rounded'>
                  <div className='flex items-center space-x-4'>
                    <label htmlFor='male' className='flex items-center space-x-4'>
                      <input
                        onChange={(event) =>
                          handleOnChange({ key: 'sex', value: event.target.value })
                        }
                        type='radio'
                        id='male'
                        name='gender'
            ...
            <div className='grid items-center grid-cols-2 space-x-4'>
              <Label label='Medication'>
                <Input
                  onChange={(event) =>
                    handleOnChange({ key: 'medication', value: event.target.value })
                  }
            ...
            <textarea
              onChange={(event) =>
                handleOnChange({ key: 'description', value: event.target.value })
              }
              cols='30'
              rows='10'
